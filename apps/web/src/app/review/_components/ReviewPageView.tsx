...
export function ReviewPageView({ model, searchParams }: { model: ReviewPageModel; searchParams: { draft?: string } }) {
  const { weekOf, data } = model;
  const { bounds, selectedWeekOf, selectedReview, pastReviews, weekBarData, sessionHeatmap, sparseHeatmap, reviewFormDefaults, generatedDraftHref, shouldUseGeneratedDraft } = data as any;
  return (
    <div className="space-y-6">
      <WeekSelector weekOf={selectedWeekOf} />
