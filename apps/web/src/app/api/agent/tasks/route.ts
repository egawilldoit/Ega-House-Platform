...
export const { POST_TASKS: POST } = createCreateHandlers(repo, rateLimiter, telemetry);
export const { PATCH_TASKS: PATCH } = createUpdateHandlers(repo, rateLimiter, telemetry);
