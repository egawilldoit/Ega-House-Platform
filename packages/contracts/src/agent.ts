...
export type AgentAuthSuccess = { ok: true; context: AgentAuthContext };
export type AgentAuthFailure = { ok: false; response: AgentErrorResponse; status: 401 | 500 };
...
export type AgentProjectListResponse = { ok: true; projects: AgentProjectResponse[] };
export type AgentGoalListResponse = { ok: true; goals: AgentGoalResponse[] };
export type AgentTaskListResponse = { ok: true; tasks: AgentTaskResponse[] };
